...
public class ShardingDataSource extends AbstractDataSourceAdapter implements AutoCloseable {
    ...
    private final ShardingProperties shardingProperties;//支持的一些参数，打印日志，是否开启度量等
    
    private final ExecutorEngine executorEngine;//sql执行引擎
    
    private final ShardingContext shardingContext;//运行时上下文
