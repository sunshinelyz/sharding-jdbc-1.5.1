...
public final class Condition {
    ...
    @Getter
    private final Column column;//列
    
    @Getter
    private final ShardingOperator operator;//分片运算符
    
    private final Map<Integer, Comparable<?>> positionValueMap = new LinkedHashMap<>();//字符表达式、数字表达式位置和参数值集合
    
    private final Map<Integer, Integer> positionIndexMap = new LinkedHashMap<>();//占位符位置和参数索引map集合
