...
public class ShardingRuleConfig {
    ...
    private Map<String, DataSource> dataSource = new HashMap<>();//数据源对象map
    
    private String defaultDataSourceName;//默认数据源名称
    
    private Map<String, TableRuleConfig> tables = new HashMap<>();//表规则
